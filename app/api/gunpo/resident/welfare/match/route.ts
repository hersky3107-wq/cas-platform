import { matchSubsidies, type MatchInput } from '@/lib/gunpo/resident/welfare'

export const runtime = 'nodejs'
export const maxDuration = 60

// ─────────────────────────────────────────────────────────────────────────────
// Gunpo 복지·행정 — 지원금 찾기. Cloned from app/api/domin/welfare/match.
// POST /api/gunpo/resident/welfare/match { age?, job?, situation?, household? }
// → { matches[], contextMeta, disclaimer, errors }
// NOT cached (user-specific). Never throws.
// ─────────────────────────────────────────────────────────────────────────────
