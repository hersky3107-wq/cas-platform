 ...
 * toggle does not need a refetch. Horizon is NOT included either: it is not a
 * per-instrument property — every instrument is offered at all 4 horizons,
 * which the caller picks at generate time (see the horizon selector).
 *
