...
const KO: Record<string, string> = {
  ...
  'astro.elements.classical_to_oheng': '서양 사원소→오행',
  ...
  // ── prism ──
  'prism.traits.core_matrix': '코어 매트릭스',
  'prism.element.resonance': '원소 공명',
  'prism.element.support': '원소 지지',
  'prism.element.output': '원소 발산',
  'prism.element.challenge': '원소 도전',
  'prism.element.pressure': '원소 압력',
  'prism.cycle.ignition': '점화 주기',
  'prism.cycle.ascent': '상승 주기',
  'prism.cycle.bloom': '개화 주기',
  'prism.cycle.tension': '긴장 주기',
  'prism.cycle.harvest': '수확 주기',
  'prism.cycle.recalibrate': '재정비 주기',
  'prism.cycle.breakthrough': '돌파 주기',
  'prism.cycle.bond': '유착 주기',
  'prism.cycle.command': '지휘 주기',
  'prism.cycle.restore': '회복 주기',
  'prism.cycle.distill': '정제 주기',
  'prism.cycle.threshold': '문턱 주기',
  ...
  // ── tarot ──
  'tarot.traits.arcana_and_suit': '아르카나·수트',
  'tarot.traits.reversals_reflected': '역위 반영',
  'tarot.elements.suit_to_classical_to_oheng': '수트→사원소→오행',
  'tarot.phase.card_character': '카드 성향',
  'tarot.no_minor_cards': '마이너 카드 없음',

  // ── runes ──
  'rune.traits.stave_character': '룬 성향',
  'rune.elements.agreed_associations_only': '합의된 원소 대응만',
  'rune.phase.direction_with_merkstave_flip': '정위·메르크스타브',
...
const EN: Record<string, string> = {
  ...
  'prism.traits.core_matrix': 'core matrix',
  'tarot.traits.arcana_and_suit': 'arcana & suit',
  'tarot.traits.reversals_reflected': 'reversals reflected',
  'tarot.elements.suit_to_classical_to_oheng': 'suit → classical → wuxing',
  'tarot.phase.card_character': 'card character',
