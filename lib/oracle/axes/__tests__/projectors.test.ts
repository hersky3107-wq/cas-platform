...
describe('projector contract', () => {
  ...
  it('three real votes produce a well-formed consensus object', () => {
    ...
    expect(consensus.phase.leaderShare).toBeGreaterThan(0)
    expect(consensus.phase.participantCount).toBeGreaterThan(0)
    expect(consensus.phase).not.toHaveProperty('verdict')
  })
})
