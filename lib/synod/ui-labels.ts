...
export const SYNOD_UI: Record<SynodLocale, SynodUiPack> = {
  en: {
    ...
    examples: [
      ...
      'Is it worth going to university in the age of AI?',
      'Does money actually buy happiness?',
    ],
    votePrompt: 'Which AI did best?',
    voteThanks: 'Thanks for voting!',
    shareHeading: 'Share this debate',
    copyLink: 'Copy link',
    copied: 'Copied!',
    goPublicHeading: 'Put this on Google',
    goPublicSubtext: 'Let search engines find this debate · No personal info shared',
    goPublicButton: 'Go Public',
    publishing: 'Publishing…',
    published: 'Indexed!',
    exit: 'Exit',
    shareTweet: 'Check out this AI debate on AIMANI!',
  ...
  ko: {
    ...
    convene: 'SYNOD 시작',
    examplesLabel: '예시로 시작해 보세요',
    examples: [
      '재택근무가 사무실 출근보다 나을까?',
      'SNS에 나이 제한을 둬야 할까?',
      'AI 시대에 대학에 가는 게 의미가 있을까?',
      '돈으로 정말 행복을 살 수 있을까?',
    ],
    votePrompt: '어떤 AI가 가장 잘했나요?',
    voteThanks: '투표해 주셔서 감사합니다!',
    shareHeading: '이 토론 공유하기',
    copyLink: '링크 복사',
    copied: '복사됨!',
    goPublicHeading: '검색에 노출하기',
    goPublicSubtext: '검색엔진이 이 토론을 찾을 수 있게 합니다 · 개인정보는 공유되지 않습니다',
    goPublicButton: '공개하기',
    publishing: '게시 중…',
    published: '등록됨!',
    exit: '나가기',
    shareTweet: 'AIMANI에서 이 AI 토론을 확인해 보세요!',
  ...
  ja: {
    ...
    shareHeading: 'この討論を共有',
    copyLink: 'リンクをコピー',
    copied: 'コピーしました！',
    goPublicHeading: '検索に表示する',
    goPublicSubtext: '検索エンジンがこの討論を見つけられるようにします · 個人情報は共有されません',
    goPublicButton: '公開する',
    publishing: '公開中…',
    published: '登録されました！',
    exit: '終了',
    shareTweet: 'AIMANIでこのAI討論をチェック！',
  ...
  'zh-TW': {
    ...
    goPublicSubtext: '讓搜尋引擎找到這場辯論 · 不會分享個人資訊',
    goPublicButton: '公開',
    publishing: '發布中…',
    published: '已收錄！',
    exit: '離開',
    shareTweet: '來 AIMANI 看看這場 AI 辯論！',
  ...
  fr: {
    ...
    examplesLabel: 'Essayez un exemple',
    examples: [
      'Le télétravail est-il meilleur que le bureau ?',
      'Faut-il imposer une limite d’âge sur les réseaux sociaux ?',
      'Aller à l’université a-t-il un sens à l’ère de l’IA ?',
      'L’argent fait-il vraiment le bonheur ?',
    ],
    votePrompt: 'Quelle IA a été la meilleure ?',
    voteThanks: 'Merci d’avoir voté !',
    shareHeading: 'Partager ce débat',
    copyLink: 'Copier le lien',
    copied: 'Copié !',
    goPublicHeading: 'Indexer sur Google',
    goPublicSubtext: 'Permettre aux moteurs de recherche de trouver ce débat · Aucune info personnelle partagée',
    goPublicButton: 'Rendre public',
    publishing: 'Publication…',
    published: 'Indexé !',
    exit: 'Quitter',
    shareTweet: 'Découvrez ce débat d’IA sur AIMANI !',
  ...
  ar: {
    ...
    examples: [
      'هل العمل عن بُعد أفضل من العمل في المكتب؟',
      'هل يجب فرض حدّ أدنى للعمر على وسائل التواصل الاجتماعي؟',
      'هل للجامعة معنى في عصر الذكاء الاصطناعي؟',
      'هل يشتري المال السعادة فعلاً؟',
    ],
    votePrompt: 'أي ذكاء اصطناعي كان الأفضل؟',
    voteThanks: 'شكراً لتصويتك!',
    shareHeading: 'شارك هذا النقاش',
    copyLink: 'نسخ الرابط',
    copied: 'تم النسخ!',
    goPublicHeading: 'اجعله ظاهراً في البحث',
    goPublicSubtext: 'دع محركات البحث تجد هذا النقاش · لا تتم مشاركة أي معلومات شخصية',
    goPublicButton: 'نشر للعامة',
    publishing: 'جارٍ النشر…',
    published: 'تم الفهرسة!',
    exit: 'خروج',
    shareTweet: 'شاهد هذا النقاش بين نماذج الذكاء الاصطناعي على AIMANI!',
  ...
  es: {
    ...
    examples: [
      '¿Es mejor el teletrabajo que la oficina?',
      '¿Debería haber un límite de edad en las redes sociales?',
      '¿Vale la pena ir a la universidad en la era de la IA?',
      '¿El dinero compra la felicidad de verdad?',
    ],
    votePrompt: '¿Qué IA lo hizo mejor?',
    voteThanks: '¡Gracias por votar!',
    shareHeading: 'Compartir este debate',
    copyLink: 'Copiar enlace',
    copied: '¡Copiado!',
    goPublicHeading: 'Indexar en Google',
    goPublicSubtext: 'Deja que los buscadores encuentren este debate · No se comparte información personal',
    goPublicButton: 'Hacer público',
    publishing: 'Publicando…',
    published: '¡Indexado!',
    exit: 'Salir',
    shareTweet: '¡Mira este debate de IA en AIMANI!',
  ...
  pt: {
    ...
    convene: 'Iniciar SYNOD',
    examplesLabel: 'Experimente um exemplo',
    examples: [
      'Trabalhar remoto é melhor do que no escritório?',
      'Deveria haver limite de idade nas redes sociais?',
      'Vale a pena ir à universidade na era da IA?',
      'O dinheiro realmente compra felicidade?',
    ],
    votePrompt: 'Qual IA se saiu melhor?',
    voteThanks: 'Obrigado por votar!',
    shareHeading: 'Compartilhar este debate',
    copyLink: 'Copiar link',
    copied: 'Copiado!',
    goPublicHeading: 'Indexar no Google',
    goPublicSubtext: 'Deixe os buscadores encontrarem este debate · Nenhuma informação pessoal é compartilhada',
    goPublicButton: 'Tornar público',
    publishing: 'Publicando…',
    published: 'Indexado!',
    exit: 'Sair',
    shareTweet: 'Veja este debate de IA no AIMANI!',
    insufficientCredits: 'Créditos insuficientes',
