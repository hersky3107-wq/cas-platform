...
export const LEAGUE_ROSTER: RosterEntry[] = [
  ...
  { model_id: 'deepseek-v4-pro', brand: 'DeepSeek', camp: 'china', league_tier: 'premier', provider_key: 'openrouter', reasoning: true, maxCompletionTokens: 7500, timeoutMs: 240_000, caller: { kind: 'platform', platformId: 'openrouter:deepseek-v4-pro' }, price: { inputPerMTokens: 0.9, outputPerMTokens: 3.5 } },
  { model_id: 'kimi-k3', brand: 'Moonshot AI', product_alias: 'Kimi', camp: 'china', league_tier: 'premier', provider_key: 'openrouter', reasoning: true, maxCompletionTokens: 4500, caller: { kind: 'platform', platformId: 'openrouter:kimi-k3' }, price: { inputPerMTokens: 0.6, outputPerMTokens: 2.5 } },
  { model_id: 'glm-5.2', brand: 'Z.ai', product_alias: 'GLM', camp: 'china', league_tier: 'premier', provider_key: 'openrouter', reasoning: true, maxCompletionTokens: 4500, caller: { kind: 'platform', platformId: 'openrouter:glm-5.2' }, price: { inputPerMTokens: 0.6, outputPerMTokens: 2.2 } },
  { model_id: 'minimax-m3', brand: 'MiniMax', camp: 'china', league_tier: 'premier', provider_key: 'openrouter', reasoning: true, maxCompletionTokens: 4500, caller: { kind: 'platform', platformId: 'openrouter:minimax-m3' }, price: { inputPerMTokens: 0.5, outputPerMTokens: 2.2 } },
  ...
  { model_id: 'nemotron-3-ultra-550b', brand: 'NVIDIA', product_alias: 'Nemotron', camp: 'us', league_tier: 'challenger', provider_key: 'openrouter', reasoning: true, maxCompletionTokens: 4500, caller: { kind: 'platform', platformId: 'openrouter:nemotron-3-ultra-550b' }, price: { inputPerMTokens: 0.6, outputPerMTokens: 2.4 } },
  ...
  { model_id: 'qwen3.5-plus', brand: 'Qwen', camp: 'china', league_tier: 'challenger', provider_key: 'openrouter', reasoning: true, maxCompletionTokens: 4500, caller: { kind: 'platform', platformId: 'openrouter:qwen3.5-plus' }, price: { inputPerMTokens: 0.6, outputPerMTokens: 3 } },
  ...
  { model_id: 'deepseek-v3.2', brand: 'DeepSeek', camp: 'china', league_tier: 'challenger', provider_key: 'openrouter', reasoning: true, maxCompletionTokens: 4500, timeoutMs: 240_000, caller: { kind: 'platform', platformId: 'openrouter:deepseek-v3.2' }, price: { inputPerMTokens: 0.5, outputPerMTokens: 2 } },
  ...
  { model_id: 'deepseek-v4-flash', brand: 'DeepSeek', camp: 'china', league_tier: 'world', provider_key: 'openrouter', reasoning: true, maxCompletionTokens: 4500, caller: { kind: 'platform', platformId: 'openrouter:deepseek-v4-flash' }, price: { inputPerMTokens: 0.3, outputPerMTokens: 1.2 } },
  { model_id: 'qwen3.5-flash', brand: 'Qwen', camp: 'china', league_tier: 'world', provider_key: 'openrouter', reasoning: true, maxCompletionTokens: 4500, caller: { kind: 'platform', platformId: 'openrouter:qwen3.5-flash' }, price: { inputPerMTokens: 0.25, outputPerMTokens: 1 } },
  { model_id: 'mimo-v2.5', brand: 'Xiaomi', product_alias: 'MiMo', camp: 'china', league_tier: 'world', provider_key: 'openrouter', reasoning: true, maxCompletionTokens: 4000, caller: { kind: 'platform', platformId: 'openrouter:mimo-v2.5' }, price: { inputPerMTokens: 0.2, outputPerMTokens: 0.6 } },
