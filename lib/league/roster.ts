...
export const LEAGUE_ROSTER: RosterEntry[] = [
  ...
  { model_id: 'gpt-5.6-sol', brand: 'OpenAI', camp: 'us', league_tier: 'premier', provider_key: 'openai', reasoning: true, caller: { kind: 'core', provider: 'openai', modelOverride: 'gpt-5.6-sol' }, price: { inputPerMTokens: 2.5, outputPerMTokens: 12.5 } },
  { model_id: 'claude-fable-5', brand: 'Anthropic', camp: 'us', league_tier: 'premier', provider_key: 'anthropic', reasoning: false, caller: { kind: 'core', provider: 'anthropic', modelOverride: 'claude-fable-5' }, price: { inputPerMTokens: 5, outputPerMTokens: 25 } },
  // Catalog id carries the -preview suffix; that IS the Gemini 3.1 Pro endpoint.
  { model_id: 'gemini-3.1-pro', brand: 'Google', camp: 'us', league_tier: 'premier', provider_key: 'google', reasoning: true, caller: { kind: 'core', provider: 'google', modelOverride: 'gemini-3.1-pro-preview', allowGeminiThinking: true }, price: { inputPerMTokens: 2, outputPerMTokens: 12 } },
  { model_id: 'grok-4.5', brand: 'xAI', camp: 'us', league_tier: 'premier', provider_key: 'xai', reasoning: true, caller: { kind: 'core', provider: 'xai', modelOverride: 'grok-4.5' }, price: { inputPerMTokens: 3, outputPerMTokens: 15 } },
  { model_id: 'muse-spark-1.2', brand: 'Meta Muse', camp: 'us', league_tier: 'premier', provider_key: 'meta-muse', reasoning: true, caller: { kind: 'platform', platformId: 'meta-muse:muse-spark-1.2' }, price: { inputPerMTokens: 0, outputPerMTokens: 0 } },
  ...
  { model_id: 'kimi-k3', brand: 'Moonshot AI', camp: 'china', league_tier: 'premier', provider_key: 'openrouter', reasoning: true, maxCompletionTokens: 3000, caller: { kind: 'platform', platformId: 'openrouter:kimi-k3' }, price: { inputPerMTokens: 0.6, outputPerMTokens: 2.5 } },
  { model_id: 'glm-5.2', brand: 'Z.ai', camp: 'china', league_tier: 'premier', provider_key: 'openrouter', reasoning: true, maxCompletionTokens: 3000, caller: { kind: 'platform', platformId: 'openrouter:glm-5.2' }, price: { inputPerMTokens: 0.6, outputPerMTokens: 2.2 } },
  ...
  // ── 🔵 CHALLENGER (10) ───────────────────────────────────────────────────
  { model_id: 'gpt-5.6-terra', brand: 'OpenAI', camp: 'us', league_tier: 'challenger', provider_key: 'openai', reasoning: true, caller: { kind: 'core', provider: 'openai', modelOverride: 'gpt-5.6-terra' }, price: { inputPerMTokens: 1.25, outputPerMTokens: 6.25 } },
  { model_id: 'claude-sonnet-5', brand: 'Anthropic', camp: 'us', league_tier: 'challenger', provider_key: 'anthropic', reasoning: false, caller: { kind: 'core', provider: 'anthropic', modelOverride: 'claude-sonnet-5' }, price: { inputPerMTokens: 3, outputPerMTokens: 15 } },
  ...
  { model_id: 'gemini-3.6-flash', brand: 'Google', camp: 'us', league_tier: 'challenger', provider_key: 'google', reasoning: true, caller: { kind: 'core', provider: 'google', modelOverride: 'gemini-3.6-flash', allowGeminiThinking: true }, price: { inputPerMTokens: 0.5, outputPerMTokens: 3 } },
  { model_id: 'grok-4.3', brand: 'xAI', camp: 'us', league_tier: 'challenger', provider_key: 'xai', reasoning: true, caller: { kind: 'core', provider: 'xai', modelOverride: 'grok-4.3' }, price: { inputPerMTokens: 1.5, outputPerMTokens: 7.5 } },
  ...
  { model_id: 'nemotron-3-ultra-550b', brand: 'NVIDIA', camp: 'us', league_tier: 'challenger', provider_key: 'openrouter', reasoning: true, maxCompletionTokens: 3000, caller: { kind: 'platform', platformId: 'openrouter:nemotron-3-ultra-550b' }, price: { inputPerMTokens: 0.6, outputPerMTokens: 2.4 } },
  ...
  { model_id: 'command-a', brand: 'Cohere', camp: 'other', league_tier: 'challenger', provider_key: 'openrouter', reasoning: false, caller: { kind: 'platform', platformId: 'openrouter:command-a' }, price: { inputPerMTokens: 2.5, outputPerMTokens: 10 } },
  ...
  { model_id: 'kimi-k2.6', brand: 'Moonshot AI', camp: 'china', league_tier: 'challenger', provider_key: 'openrouter', reasoning: true, maxCompletionTokens: 8000, timeoutMs: 240_000, caller: { kind: 'platform', platformId: 'openrouter:kimi-k2.6' }, price: { inputPerMTokens: 0.5, outputPerMTokens: 2 } },

  // ── 🟢 WORLD (14) — incl. the three Korean models (no sovereign tier) ────
  { model_id: 'gpt-5.6-luna', brand: 'OpenAI', camp: 'us', league_tier: 'world', provider_key: 'openai', reasoning: true, caller: { kind: 'core', provider: 'openai', modelOverride: 'gpt-5.6-luna' }, price: { inputPerMTokens: 0.5, outputPerMTokens: 2.5 } },
  { model_id: 'claude-haiku-4.5', brand: 'Anthropic', camp: 'us', league_tier: 'world', provider_key: 'anthropic', reasoning: false, caller: { kind: 'core', provider: 'anthropic', modelOverride: 'claude-haiku-4-5-20251001' }, price: { inputPerMTokens: 1, outputPerMTokens: 5 } },
  { model_id: 'gemini-3.5-flash-lite', brand: 'Google', camp: 'us', league_tier: 'world', provider_key: 'google', reasoning: true, caller: { kind: 'core', provider: 'google', modelOverride: 'gemini-3.5-flash-lite', allowGeminiThinking: true }, price: { inputPerMTokens: 0.15, outputPerMTokens: 1 } },
  { model_id: 'llama-4-maverick', brand: 'Meta', camp: 'us', league_tier: 'world', provider_key: 'openrouter', reasoning: false, caller: { kind: 'platform', platformId: 'openrouter:llama-4-maverick' }, price: { inputPerMTokens: 0.2, outputPerMTokens: 0.6 } },
  { model_id: 'nova-2-lite', brand: 'Amazon', camp: 'us', league_tier: 'world', provider_key: 'openrouter', reasoning: false, caller: { kind: 'platform', platformId: 'openrouter:nova-2-lite' }, price: { inputPerMTokens: 0.06, outputPerMTokens: 0.24 } },
  { model_id: 'phi-4', brand: 'Microsoft', camp: 'us', league_tier: 'world', provider_key: 'openrouter', reasoning: false, caller: { kind: 'platform', platformId: 'openrouter:phi-4' }, price: { inputPerMTokens: 0.07, outputPerMTokens: 0.14 } },
  ...
  { model_id: 'mimo-v2.5', brand: 'Xiaomi', camp: 'china', league_tier: 'world', provider_key: 'openrouter', reasoning: true, maxCompletionTokens: 2500, caller: { kind: 'platform', platformId: 'openrouter:mimo-v2.5' }, price: { inputPerMTokens: 0.2, outputPerMTokens: 0.6 } },
  { model_id: 'solar-pro3', brand: 'Upstage', camp: 'other', league_tier: 'world', provider_key: 'upstage', reasoning: true, caller: { kind: 'platform', platformId: 'upstage:solar-pro3' }, price: { inputPerMTokens: 0.25, outputPerMTokens: 1 } },
  { model_id: 'hcx-007', brand: 'NAVER', camp: 'other', league_tier: 'world', provider_key: 'clova', reasoning: false, caller: { kind: 'platform', platformId: 'clova:hcx-007' }, price: { inputPerMTokens: 0, outputPerMTokens: 0 } },
  { model_id: 'k-exaone-2.0', brand: 'LG', camp: 'other', league_tier: 'world', provider_key: 'friendli', reasoning: true, caller: { kind: 'platform', platformId: 'friendli:exaone-k-2.0' }, price: { inputPerMTokens: 0, outputPerMTokens: 0 } },
  ...
  { model_id: 'gpt-5-search-api', brand: 'OpenAI', camp: 'us', league_tier: 'scout', provider_key: 'openai', reasoning: false, maxCompletionTokens: 1600, caller: { kind: 'core', provider: 'openai', modelOverride: 'gpt-5-search-api' }, price: { inputPerMTokens: 1.25, outputPerMTokens: 10 } },
  { model_id: 'gemini-3.6-flash-grounded', brand: 'Google', camp: 'us', league_tier: 'scout', provider_key: 'google', reasoning: true, maxCompletionTokens: 2500, caller: { kind: 'core', provider: 'google', modelOverride: 'gemini-3.6-flash', allowGeminiThinking: true, searchTool: true }, price: { inputPerMTokens: 0.5, outputPerMTokens: 3 } },
  ...
  { model_id: 'grok-4.6-livesearch', brand: 'xAI', camp: 'us', league_tier: 'scout', provider_key: 'xai', reasoning: true, maxCompletionTokens: 2500, timeoutMs: 150_000, caller: { kind: 'core', provider: 'xai', modelOverride: 'grok-4.6', searchTool: true }, price: { inputPerMTokens: 3, outputPerMTokens: 15 } },
  { model_id: 'claude-sonnet-5-websearch', brand: 'Anthropic', camp: 'us', league_tier: 'scout', provider_key: 'anthropic', reasoning: false, maxCompletionTokens: 1600, caller: { kind: 'core', provider: 'anthropic', modelOverride: 'claude-sonnet-5', searchTool: true }, price: { inputPerMTokens: 3, outputPerMTokens: 15 } },
  { model_id: 'sonar-reasoning-pro', brand: 'Perplexity', camp: 'us', league_tier: 'scout', provider_key: 'perplexity', reasoning: true, maxCompletionTokens: 1600, caller: { kind: 'core', provider: 'perplexity', modelOverride: 'sonar-reasoning-pro' }, price: { inputPerMTokens: 2, outputPerMTokens: 8 } },
