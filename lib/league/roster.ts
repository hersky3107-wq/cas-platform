...
export const LEAGUE_ROSTER: RosterEntry[] = [
  ...
  { model_id: 'gpt-5.6-sol', brand: 'OpenAI', product_alias: 'ChatGPT', camp: 'us', league_tier: 'premier', provider_key: 'openai', reasoning: true, caller: { kind: 'core', provider: 'openai', modelOverride: 'gpt-5.6-sol' }, price: { inputPerMTokens: 4, outputPerMTokens: 20 } },
  { model_id: 'claude-fable-5', brand: 'Anthropic', product_alias: 'Claude', camp: 'us', league_tier: 'premier', provider_key: 'anthropic', reasoning: false, caller: { kind: 'core', provider: 'anthropic', modelOverride: 'claude-fable-5' }, price: { inputPerMTokens: 10, outputPerMTokens: 50 } },
  // Catalog id carries the -preview suffix; that IS the Gemini 3.1 Pro endpoint.
  { model_id: 'gemini-3.1-pro', brand: 'Google', product_alias: 'Gemini', camp: 'us', league_tier: 'premier', provider_key: 'google', reasoning: true, caller: { kind: 'core', provider: 'google', modelOverride: 'gemini-3.1-pro-preview', allowGeminiThinking: true }, price: { inputPerMTokens: 2, outputPerMTokens: 12, longContext: { promptTokens: 200_000, inputPerMTokens: 4, outputPerMTokens: 18 } } },
  ...
  { model_id: 'muse-spark-1.2', brand: 'Meta Muse', product_alias: 'Muse', camp: 'us', league_tier: 'premier', provider_key: 'meta-muse', reasoning: true, caller: { kind: 'platform', platformId: 'meta-muse:muse-spark-1.2' }, price: { inputPerMTokens: 1.25, outputPerMTokens: 4.25 } },
  { model_id: 'qwen3.8-max', brand: 'Qwen', camp: 'china', league_tier: 'premier', provider_key: 'openrouter', reasoning: true, maxCompletionTokens: 4500, caller: { kind: 'platform', platformId: 'openrouter:qwen3.8-max' }, price: { inputPerMTokens: 2, outputPerMTokens: 6 } },
  ...
  { model_id: 'deepseek-v4-pro', brand: 'DeepSeek', camp: 'china', league_tier: 'premier', provider_key: 'openrouter', reasoning: true, maxCompletionTokens: 7500, timeoutMs: 240_000, caller: { kind: 'platform', platformId: 'openrouter:deepseek-v4-pro' }, price: { inputPerMTokens: 0.65, outputPerMTokens: 1.3 } },
  { model_id: 'kimi-k3', brand: 'Moonshot AI', product_alias: 'Kimi', camp: 'china', league_tier: 'premier', provider_key: 'openrouter', reasoning: true, maxCompletionTokens: 4500, caller: { kind: 'platform', platformId: 'openrouter:kimi-k3' }, price: { inputPerMTokens: 3, outputPerMTokens: 15 } },
  { model_id: 'glm-5.2', brand: 'Z.ai', product_alias: 'GLM', camp: 'china', league_tier: 'premier', provider_key: 'openrouter', reasoning: true, maxCompletionTokens: 4500, caller: { kind: 'platform', platformId: 'openrouter:glm-5.2' }, price: { inputPerMTokens: 1.19, outputPerMTokens: 3.74 } },
  { model_id: 'minimax-m3', brand: 'MiniMax', camp: 'china', league_tier: 'premier', provider_key: 'openrouter', reasoning: true, maxCompletionTokens: 4500, caller: { kind: 'platform', platformId: 'openrouter:minimax-m3' }, price: { inputPerMTokens: 0.3, outputPerMTokens: 1.2 } },

  // ── 🔵 CHALLENGER (10) ───────────────────────────────────────────────────
  { model_id: 'gpt-5.6-terra', brand: 'OpenAI', product_alias: 'ChatGPT', camp: 'us', league_tier: 'challenger', provider_key: 'openai', reasoning: true, caller: { kind: 'core', provider: 'openai', modelOverride: 'gpt-5.6-terra' }, price: { inputPerMTokens: 2, outputPerMTokens: 12 } },
  { model_id: 'claude-sonnet-5', brand: 'Anthropic', product_alias: 'Claude', camp: 'us', league_tier: 'challenger', provider_key: 'anthropic', reasoning: false, caller: { kind: 'core', provider: 'anthropic', modelOverride: 'claude-sonnet-5' }, price: { inputPerMTokens: 2, outputPerMTokens: 10 } },
  ...
  { model_id: 'gemini-3.6-flash', brand: 'Google', product_alias: 'Gemini', camp: 'us', league_tier: 'challenger', provider_key: 'google', reasoning: true, caller: { kind: 'core', provider: 'google', modelOverride: 'gemini-3.6-flash', allowGeminiThinking: true }, price: { inputPerMTokens: 1.5, outputPerMTokens: 7.5 } },
  { model_id: 'grok-4.3', brand: 'xAI', product_alias: 'Grok', camp: 'us', league_tier: 'challenger', provider_key: 'xai', reasoning: true, caller: { kind: 'core', provider: 'xai', modelOverride: 'grok-4.3' }, price: XAI_GROK_43_PRICE },
  ...
  { model_id: 'nemotron-3-ultra-550b', brand: 'NVIDIA', product_alias: 'Nemotron', camp: 'us', league_tier: 'challenger', provider_key: 'openrouter', reasoning: true, maxCompletionTokens: 4500, caller: { kind: 'platform', platformId: 'openrouter:nemotron-3-ultra-550b' },     price: { inputPerMTokens: 0.5, outputPerMTokens: 2.2 } },
  { model_id: 'mistral-medium-3.5', brand: 'Mistral', camp: 'other', league_tier: 'challenger', provider_key: 'openrouter', reasoning: false, caller: { kind: 'platform', platformId: 'openrouter:mistral-medium-3.5' }, price: { inputPerMTokens: 1.5, outputPerMTokens: 7.5 } },
  ...
  { model_id: 'qwen3.5-plus', brand: 'Qwen', camp: 'china', league_tier: 'challenger', provider_key: 'openrouter', reasoning: true, maxCompletionTokens: 4500, caller: { kind: 'platform', platformId: 'openrouter:qwen3.5-plus' }, price: { inputPerMTokens: 0.3, outputPerMTokens: 1.8 } },
  ...
  { model_id: 'deepseek-v3.2', brand: 'DeepSeek', camp: 'china', league_tier: 'challenger', provider_key: 'openrouter', reasoning: true, maxCompletionTokens: 4500, timeoutMs: 240_000, caller: { kind: 'platform', platformId: 'openrouter:deepseek-v3.2' }, price: { inputPerMTokens: 0.269, outputPerMTokens: 0.4 } },
  ...
  { model_id: 'llama-4-maverick', brand: 'Meta', product_alias: 'Llama', camp: 'us', league_tier: 'world', provider_key: 'openrouter', reasoning: false, caller: { kind: 'platform', platformId: 'openrouter:llama-4-maverick' }, price: { inputPerMTokens: 0.2, outputPerMTokens: 0.8 } },
  { model_id: 'nova-2-lite', brand: 'Amazon', product_alias: 'Nova', camp: 'us', league_tier: 'world', provider_key: 'openrouter', reasoning: false, caller: { kind: 'platform', platformId: 'openrouter:nova-2-lite' }, price: { inputPerMTokens: 0.3, outputPerMTokens: 2.5 } },
  ...
  { model_id: 'deepseek-v4-flash', brand: 'DeepSeek', camp: 'china', league_tier: 'world', provider_key: 'openrouter', reasoning: true, maxCompletionTokens: 4500, caller: { kind: 'platform', platformId: 'openrouter:deepseek-v4-flash' }, price: { inputPerMTokens: 0.084, outputPerMTokens: 0.168 } },
  { model_id: 'qwen3.5-flash', brand: 'Qwen', camp: 'china', league_tier: 'world', provider_key: 'openrouter', reasoning: true, maxCompletionTokens: 4500, caller: { kind: 'platform', platformId: 'openrouter:qwen3.5-flash' }, price: { inputPerMTokens: 0.065, outputPerMTokens: 0.26 } },
  ...
  { model_id: 'claude-sonnet-5-websearch', brand: 'Anthropic', product_alias: 'Claude', camp: 'us', league_tier: 'scout', provider_key: 'anthropic', reasoning: false, maxCompletionTokens: 1600, caller: { kind: 'core', provider: 'anthropic', modelOverride: 'claude-sonnet-5', searchTool: true }, price: { inputPerMTokens: 2, outputPerMTokens: 10 } },
