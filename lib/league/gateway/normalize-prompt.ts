...
const SLOT_HINT: Record<PublicCategoryId, string> = {
  ...
  gold_metals: 'entity_mention = gold, silver, XAU/USD, XAG/USD, GLD, or SLV. Empty if they named none.',
  index_etf: 'entity_mention = the index or ETF the user named (spy, qqq…). Empty if they named none.',
  commodities_energy: 'entity_mention = oil/gas (wti, brent, ung…). Empty if they named none.',
