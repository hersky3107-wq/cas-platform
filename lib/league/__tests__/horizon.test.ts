...
describe('usesTradingSessions', () => {
  it('is true for stock / etf_index / real_estate (REIT ETFs share the equity clock)', () => {
    ...
    expect(usesTradingSessions('commodity_energy', 'WEAT')).toBe(true)
    expect(usesTradingSessions('commodity_energy', 'SOYB')).toBe(true)
    expect(usesTradingSessions('commodity_energy', 'COFF')).toBe(true)
