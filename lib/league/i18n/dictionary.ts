...
const en: LeagueUiPack = {
  ...
  catalog: {
    ...
    instruments: {
      ...
      'USD/CNH': 'US Dollar / Offshore Yuan',
      'AUD/USD': 'Australian Dollar / US Dollar',
      'JPY/KRW': 'Yen / Korean Won',
      'EUR/JPY': 'Euro / Yen',
      'GBP/JPY': 'Pound / Yen',
      'XAU/USD': 'Gold spot',
      'XAG/USD': 'Silver spot',
      ...
      SQQQ: 'Nasdaq -3x (SQQQ)',
      SOXL: 'Semis 3x (SOXL)',
      UPRO: 'S&P 500 3x (UPRO)',
      SPXU: 'S&P 500 -3x (SPXU)',
      'WTI/USD': 'WTI Crude',
      'XBR/USD': 'Brent Crude',
      UNG: 'US Natural Gas (UNG)',
      CPER: 'Copper ETF (CPER)',
      CORN: 'Corn ETF (CORN)',
      WEAT: 'Wheat ETF (WEAT)',
      SOYB: 'Soybean ETF (SOYB)',
      COFF: 'Coffee ETF (COFF)',
...
const ko: LeagueUiPack = {
  ...
  catalog: {
    ...
    instruments: {
      ...
      EWJ: '일본 ETF (EWJ)',
      EWY: '한국 ETF (EWY)',
      FEZ: '유럽 STOXX50 ETF (FEZ)',
      EWT: '대만 ETF (EWT)',
      TQQQ: '나스닥 3배 (TQQQ)',
      SQQQ: '나스닥 역3배 (SQQQ)',
      SOXL: '반도체 3배 (SOXL)',
      UPRO: 'S&P 500 3배 (UPRO)',
      SPXU: 'S&P 500 역3배 (SPXU)',
      'WTI/USD': '원유 WTI',
      'XBR/USD': '브렌트유',
      UNG: '천연가스 ETF',
      CPER: '구리',
...
const ja: LeagueUiPack = {
  ...
  catalog: {
    ...
    instruments: {
      ...
      EWJ: '日本 ETF (EWJ)',
      EWY: '韓国 ETF (EWY)',
      FEZ: 'ユーロストックス50 ETF (FEZ)',
      EWT: '台湾 ETF (EWT)',
      TQQQ: 'ナスダック 3倍 (TQQQ)',
      SQQQ: 'ナスダック -3倍 (SQQQ)',
      SOXL: '半導体 3倍 (SOXL)',
      UPRO: 'S&P 500 3倍 (UPRO)',
      SPXU: 'S&P 500 -3倍 (SPXU)',
      'WTI/USD': 'WTI原油',
      'XBR/USD': 'ブレント原油',
      UNG: '天然ガス ETF (UNG)',
      CPER: '銅 ETF (CPER)',
      CORN: 'トウモロコシ ETF (CORN)',
      WEAT: '小麦 ETF (WEAT)',
      SOYB: '大豆 ETF (SOYB)',
      COFF: 'コーヒー ETF (COFF)',
      VNQ: 'バンガード REIT (VNQ)',
...
const fr: LeagueUiPack = {
  ...
  catalog: {
    ...
    instruments: {
      ...
      SPY: 'S&P 500 ETF (SPY)',
      QQQ: 'Nasdaq-100 ETF (QQQ)',
      DIA: 'ETF Dow Jones (DIA)',
      EWJ: 'ETF Japon (EWJ)',
      EWY: 'ETF Corée (EWY)',
      FEZ: 'ETF Euro Stoxx 50 (FEZ)',
      EWT: 'ETF Taïwan (EWT)',
      TQQQ: 'Nasdaq 3x (TQQQ)',
      SQQQ: 'Nasdaq -3x (SQQQ)',
      SOXL: 'Semi 3x (SOXL)',
      ...
      SPXU: 'S&P 500 -3x (SPXU)',
      'WTI/USD': 'Pétrole WTI',
      'XBR/USD': 'Pétrole Brent',
      UNG: 'Gaz naturel (UNG)',
      CPER: 'Cuivre ETF (CPER)',
      CORN: 'Maïs ETF (CORN)',
      WEAT: 'Blé ETF (WEAT)',
      SOYB: 'Soja ETF (SOYB)',
      COFF: 'Café ETF (COFF)',
...
const es: LeagueUiPack = {
  ...
  catalog: {
    ...
    instruments: {
      ...
      TQQQ: 'Nasdaq 3x (TQQQ)',
      SQQQ: 'Nasdaq -3x (SQQQ)',
      SOXL: 'Semiconductores 3x (SOXL)',
      UPRO: 'S&P 500 3x (UPRO)',
      SPXU: 'S&P 500 -3x (SPXU)',
      'WTI/USD': 'Petróleo WTI',
      'XBR/USD': 'Petróleo Brent',
      UNG: 'Gas natural (UNG)',
      CPER: 'Cobre ETF (CPER)',
      CORN: 'Maíz ETF (CORN)',
      WEAT: 'Trigo ETF (WEAT)',
...
const ar: LeagueUiPack = {
  ...
  catalog: {
    ...
    instruments: {
      ...
      DIA: 'داو جونز ETF (DIA)',
      EWJ: 'اليابان ETF (EWJ)',
      EWY: 'كوريا ETF (EWY)',
      FEZ: 'يورو ستوكس 50 ETF (FEZ)',
      EWT: 'تايوان ETF (EWT)',
      TQQQ: 'ناسداك 3x (TQQQ)',
      SQQQ: 'ناسداك -3x (SQQQ)',
      SOXL: 'أشباه موصلات 3x (SOXL)',
      UPRO: 'S&P 500 3x (UPRO)',
      SPXU: 'S&P 500 -3x (SPXU)',
...
const pt: LeagueUiPack = {
  ...
  catalog: {
    ...
    instruments: {
      ...
      'GBP/USD': 'Libra / Dólar americano',
      'USD/CNH': 'Dólar americano / Yuan offshore',
      'AUD/USD': 'Dólar australiano / Dólar americano',
      'JPY/KRW': 'Iene / Won sul-coreano',
      'EUR/JPY': 'Euro / Iene',
      'GBP/JPY': 'Libra / Iene',
