...
/**
 * FriendlyErrors — shared resident-chip error notice. Cloned as-is from
 * components/jeju/FriendlyErrors.tsx (generic, no Jeju-specific logic).
 *
...
const LABELS: [RegExp, string][] = [
  ...
  [/^warn/i, '기상특보'],
  [/^(forecast|weather|current|midterm)/i, '날씨 예보'],
  [/^flight/i, '항공 정보'],
  [/^(ferry|ship)/i, '여객선 정보'],
  [/^welfare/i, '복지 공고'],
  [/^(route|ai)/i, 'AI 응답'],
