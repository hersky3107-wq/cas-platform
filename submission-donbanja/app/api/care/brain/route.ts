...
/**
 * 오늘의 뇌 운동 — daily elderly-friendly cognitive exercise for the 동반자 app.
 *
 * Cache table: `care_brain`.
 * Cache key is `YYYY-MM-DD-<level>` in `care_brain.day`, so each
 * difficulty level caches independently under the unique constraint.
