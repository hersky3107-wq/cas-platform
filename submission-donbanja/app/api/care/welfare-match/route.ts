...
export async function POST(req: Request) {
  ...
  // Residence-driven region (welfareRegionKey slug). Matches local-government
  // rows for that province plus 'national' central-government rows.
  // sido/sigungu are carried for display / future enrichment.
